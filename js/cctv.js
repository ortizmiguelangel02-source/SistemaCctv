const modal = document.getElementById("modalCotizacion");
      ...
      form.onsubmit = function (e) {
        ...
        const mensajeWpp =
          ...
          `*Pago:* ${metodoPago.toUpperCase()}%0A` +
          `*Instalación:* ${requiereInstala}%0A` +
          `------------------------------%0A` +
          `_Enviado desde el catálogo web._`;

        // 4. Construir la URL y abrir en pestaña nueva
        const urlFinal = `https://api.whatsapp.com/send?phone=${3194709052}&text=${mensajeWpp}`;
